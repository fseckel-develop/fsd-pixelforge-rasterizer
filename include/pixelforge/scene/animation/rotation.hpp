...
namespace pixelforge::scene::animation {
    ...
    public:
        ...
        Rotation(Mode mode, float duration, const glm::vec3& axis, float angle = 360.0f);
    ...
    protected:
        ...
        float totalAngle_; ///< Total rotation angle in degrees reached at 100% animation progress.
    };
